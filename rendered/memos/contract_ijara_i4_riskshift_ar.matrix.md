...
|---|---|---|---|---|---|---|---|---|
| I4 | violated | العيب المزروع: I4 — نقلُ تبعة الملكية إلى المستأجر (أشيعُ خللٍ في الإجارة) | بقاءُ تبعة الملكية على المؤجِّر (الاختبارُ المركزي) / Ownership risk stays with the lessor (the central test)<br>[L1] CBK Circular 2/IBS/369/2016<br>[L3] AAOIFI Sharia Standard No. 9 (Ijarah) — the parties' respective liabilities; insurance as takaful at the lessor's expense<br>[L2] SYNTHETIC SSB fatwa SSB-SYNTH-IJR-004 | جسيم / major | تنظيميّ/ماليّ / regulatory/financial | إعادةُ تبعة الملكية (الصيانة الأساسية والتكافل والتلف الكلّي) إلى المؤجِّر؛ تصحيحُ البنود؛ والعرضُ على الهيئة. <br> Return ownership risk (basic maintenance, takaful, total-loss) to the lessor; rectify the clauses; escalate to the SSB. | open | ____ |
