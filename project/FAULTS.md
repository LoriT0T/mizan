...
_No other faults this build. The validation suite (`validation/run_all.py`) is green; all 31 isolated unit tests pass; both fail-closed guards demonstrated._
